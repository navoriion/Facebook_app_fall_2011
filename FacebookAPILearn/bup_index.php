...
<html xmlns:fb="http://www.facebook.com/2008/fbml">
    ...
    <body>
        ...
        <?php if ($user): ?>
          <a href="<?php echo $logoutUrl; ?>"><b>Logout of Facebook</b></a>
        <?php else: ?>
          <a href="<?php echo $loginUrl; ?>"><b>Login with Facebook</b></a>
        <?php endif ?>
        ...
        <script type="text/javascript">
            ...
            if(window.top == window)
                    top.location = '<? echo $facebook_canvas_location . $_SERVER['REQUEST_URI'] ?>';
                ...
                FB.init(
                            {
                                ...
                                channelUrl : 'http://vishaknag.com/channel.html'
                            }
                        );
